...
Route::prefix('/settings/')->name('settings.')->middleware('auth')->group(function () {
    Route::get('/', 'Auth\AccountController@show')->name('show');
    Route::get('/{user}', 'Auth\AccountController@show')->middleware('admin')->name('show.admin');

    Route::post('/image', 'Auth\AccountController@image')->name('image');
    Route::put('/{user}', 'Auth\AccountController@update')->name('update');
});
