<div class="card mt-2">
    <div class="card-body">
        <ul class="list-unstyled mb-0">
            <li><a href="{{ route('article.index', ['sort' => 'date.desc']) }}"><i class="fas fa-calendar mr-2"></i>Новые</a></li>
            <li><a href="{{ route('article.index', ['filter' => 'points.desc']) }}"><i class="fas fa-heart mr-2"></i>Популярные</a></li>
